...
CREATE TABLE stage.eventos_apocalipticos (
...
WHERE 
  table_name = 'eventos_apocalipticos';



INSERT INTO stage.eventos_apocalipticos (id_evento, nombre_evento ,fecha_evento , descripcion_evento)
VALUES
...
CREATE TABLE prod.prediccion_fin_mundo (
...
FROM 
  information_schema.columns 
WHERE 
  table_name = 'prediccion_fin_mundo';
